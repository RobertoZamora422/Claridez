"""Perfil del worker documental canónico con el mismo rol limitado de aplicación."""

from .base import *  # noqa: F403
from .base import build_database_configuration, build_logging_configuration
from .environment import load_document_worker_settings

_worker = load_document_worker_settings()
